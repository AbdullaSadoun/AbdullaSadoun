"""
Django settings for Django_Portfilio_AbdullaSadoun project.
...
ROOT_URLCONF = 'Django_Portfilio_AbdullaSadoun.urls'
...
WSGI_APPLICATION = 'Django_Portfilio_AbdullaSadoun.wsgi.application'
